...
<section class="content">
	...
	<div class="page__c">
		...
		<p>Ваши отзывы о пребывании в йога-лагере <?=$arResult["NAME"]?> вы можете оставлять в комментариях на этой странице.</p>

		<p>
			<?=htmlspecialcharsBack($arResult["PROPERTIES"]["reviews"]["VALUE"]["TEXT"])?>
		</p>
